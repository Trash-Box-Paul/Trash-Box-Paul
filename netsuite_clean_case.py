...
class CleanAllCase:
    ...
    def refresh_list(self):
        ...
        noise = self.find_element_visible("/html/body/div[1]/div[2]/div/div/div/div[5]/div[2]/div[1]/div[2]/div/div/form/div["
        ...
        element = self.driver.find_element(By.XPATH, "/html/body/div[1]/div[2]/div/div/div/div[5]/div[2]/div[1]/div["
                                                     "1]/div/div/ul")
        self.show1(element)
        element = self.find_element_visible("//div[2]/div/div/h2")
        ...
        element = self.find_element_visible(refresh_icon)
        self.show1(element)
    ...
    def refresh_list_down(self):
        ...
        ele = self.find_element_visible("/html/body/div[1]/div[2]/div/div/div/div[5]/div[2]/div[2]/div[1]/div")
        self.show1(ele)
        element = self.find_element_visible(refresh_icon)
        self.show1(element)
        element = self.find_element_visible(title_list)
        actions = ActionChains(self.driver)
        actions.move_to_element(element).perform()
        # 2 | MouseMoveAt | Title: Paul's All Case View | hover element
        element = self.find_element_visible(refresh_icon)
    ...
    def clean_all_case(self):
        ...
        filename = "./log/clean_list_log/" + datetime.now().strftime("%b_%d_%Y") + "_clean_list_log.txt"
        file1 = open(filename, "a+")
        self.driver.execute_script('arguments[0].click()', self.find_element_visible(tab_case))
        # 1 | click | case tab |
        ...
        while case_sum > 0:
            if case_sum <= 0:
                ...
                ele = self.find_element_visible(first_row_inner_xpath)
            ...
            ele = self.find_element_visible(last_row_xpath)
            self.driver.execute_script('arguments[0].click()', ele)
            time.sleep(1)
            ele = self.find_element_visible(input_box)
            self.driver.execute_script('arguments[0].click()', ele)
            ele.send_keys("Closed")
            self.driver.switch_to.window(self.current)
            time.sleep(1)
            # 4 | shift + last line
            ele = self.find_element_visible(first_row_xpath)
            ...
            ele = self.find_element_visible(number_sum)
            html = ele.get_attribute('innerHTML')
            case_sum = int(html)
        file1.close()
        return log
    ...
    def change_criteria(self, search_type, key_word):
        ...
        self.find_element_visible(title)
        title = "/html/body/div[1]/div[2]/div/div/div/div[5]/div[2]/div[1]/div[1]/h2"
        element = self.find_element_visible(title)
        ...
        self.find_element_visible("/html/body/div[1]/div[2]/div/div/div/div[5]/div[2]/div[1]/div[2]/div/div/form/div[2]/table[1]")
        # self.hide(ele1)
        ele2 = self.find_element_visible(
        ...
        ele = self.driver.find_element(By.XPATH, "/html/body/div[1]/div[2]/div/div/div/div[5]/div[2]/div[1]/div["
                                                 "1]/div/div/ul")
        self.show(ele)
        ele = self.find_element_visible("/html/body/div[1]/div[2]/div/div/div/div[5]/div[2]/div[1]/div[1]/div/div/ul/li[3]")
        self.show(ele)
        element = self.find_element_visible("/html/body/div[1]/div[2]/div/div/div/div[5]/div[2]/div[1]/div[1]/div/div/ul/li[3]/a")
        while element.get_attribute("innerHTML") is None:
            element = self.find_element_visible("/html/body/div[1]/div[2]/div/div/div/div[5]/div[2]/div[1]/div[1]/div/div/ul/li[3]/a")
            # print(1)
        ...
        self.driver.execute_script('arguments[0].click()', self.find_element_visible("/html/body/div[1]/div[2]/div[3]/table["
        ...
        self.driver.execute_script(self.find_element_visible(criteria_subject).get_attribute("onclick"))
        # actions = ActionChains(self.driver)
        ...
        ele = self.find_element_visible(first_line)
        self.driver.execute_script('arguments[0].click()', ele)
        ...
        element = self.find_element_visible(arrow)
        self.show(element)
        self.driver.execute_script('arguments[0].click()', element)

        iframe = "/html/body/div[9]/div[2]/div[1]/div/div/iframe"
        current_handle = self.driver.current_window_handle
        element = self.find_element_visible(iframe)
        ...
        self.driver.execute_script('arguments[0].click()', self.find_element_visible(textbox_1))
        self.find_element_visible(textbox_1_1).send_keys(search_type)
        # 3 | Input | Search Type
        ...
        element = self.find_element_visible("/html/body/div[1]/div/div[4]/form/table/tbody/tr["
        ...
        element = self.find_element_visible(template)
        self.driver.execute_script('arguments[0].click()', element)
        # 6 | Click | Save
    ...
    def take_task(self):
        ...
        target_url = "https://907826.app.netsuite.com/app/center/card.nl?sc=-29&whence=#"
        self.driver.get(target_url)
        self.driver.execute_script('arguments[0].click()', self.find_element_visible(tab_home))
        ...
        while case_sum > 0:
            if case_sum <= 0:
                ...
                # print(last_row_xpath)
                # 3 | click | first row |
                self.driver.get(self.find_element_visible(first_pencil).get_attribute("href"))
                self.find_element_visible(input_name).send_keys(Keys.CONTROL + "a")
                ...
                time.sleep(2)
                # 4 | shift + last line
                self.driver.execute_script(self.find_element_visible(save_icon).get_attribute('onclick'))
                self.driver.get("https://907826.app.netsuite.com/app/center/card.nl?sc=-29&whence=")
                time.sleep(1)
                self.refresh_list_down()
                self.driver.execute_script('arguments[0].click()', self.find_element_visible(tab_home))
    ...
    def resend_all_case(self):
        # Step # | name | target | value
        filename = "./resend_list_log/" +datetime.now().strftime("%b_%d_%Y") + "_resend_log.txt"
        file1 = open(filename, "a+")
        tab_case = "/html/body/div[1]/div[1]/div[2]/ul[4]/li[2]/a/span"
        self.driver.execute_script('arguments[0].click()', self.find_element_visible(tab_case))
        # 1 | click | case tab |
        ...
        while case_sum > 0:
            if case_sum <= 0:
                ...
                tr_group = table_body.find_all('tr')
                log_group = []
                self.driver.execute_script('arguments[0].click()', self.find_element_visible(first_row_xpath))
                self.find_element_visible(input_box).send_keys("Closed" + Keys.ENTER)
                time.sleep(1)
    ...
    def cloud_ftp(self, profile_name):
        ...
        ele = self.find_element_visible(search_input)
        ele.send_keys(profile_name)
        self.driver.execute_script('arguments[0].click()', self.find_element_visible("/html/body/form/table/tbody/tr[2]/td["
        ...
        try:
            ...
            self.driver.execute_script('arguments[0].click()', self.find_element_visible("/html/body/form/table/tbody/tr["
            ...
            ele = self.find_element_visible(ftp_setup)
            actions = ActionChains(self.driver)
            actions.move_to_element(ele)
            actions.click(ele).perform()
            ele = self.find_element_visible(setup_inbox)
            ele.send_keys(profile_name)
            self.driver.execute_script('arguments[0].click()', self.find_element_visible("/html/body/form/table/tbody/tr["
            ...
            self.driver.execute_script('arguments[0].click()', self.find_element_visible("/html/body/form/table/tbody/tr[3]/td/div/div["
                                                                         "1]/div/table/tbody/tr[5]/td/input[2]"))
            self.driver.execute_script('arguments[0].click()', self.find_element_visible("/html/body/form/table/tbody/tr[3]/td/div/div["
                                                                         "1]/div/table/tbody/tr[6]/td/input"))

    def find_element_visible(self, xpath):
        try:
